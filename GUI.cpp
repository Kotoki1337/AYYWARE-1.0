...
bool CGUI::DrawWindow(CWindow* window)
{
	...
	// Main Window
	Render::Outline(window->m_x, window->m_y, window->m_iWidth, window->m_iHeight, Color(34, 156, 255, 80));
	Render::GradientV(window->m_x + 2, window->m_y + 2, window->m_iWidth - 4, 26, Color(34, 156, 255, 255), Color(34, 156, 255, 255));
	Render::Clear(window->m_x + 2, window->m_y + 2 + 26, window->m_iWidth - 4, window->m_iHeight - 4 - 26, Color(34, 156, 255, 255));
