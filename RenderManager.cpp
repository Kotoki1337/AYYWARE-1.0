...
void Render::Initialise()
{
	...
	Fonts::GroupBoxIcon = Interfaces::Surface->FontCreate();
	Fonts::GroupBoxIcon2 = Interfaces::Surface->FontCreate();
	...
	Fonts::visuals_esp_font = Interfaces::Surface->FontCreate();
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "Bahnschrift Semibold", 14, 250, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Tahoma", 12, 300, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::GroupBoxIcon, "undefeated", 10, 200, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::GroupBoxIcon2, "Astriumtabs2", 17, 200, 0, 0, FONTFLAG_ANTIALIAS);

	Interfaces::Surface->SetFontGlyphSet(Fonts::visuals_esp_font, "Smallest Pixel-7", 10, 100, 0, 0, FONTFLAG_OUTLINE);
